...
with Diagram("Relationships", filename=f"{base_dir}/bref_building_something_5_diagram", show=False):
    ...
    client >> Edge(label="Viewing Images") << aws_image_bucket 
    developer >> Edge(label="Bref CLI Console Invoke") << aws_console_lambda
    aws_frontend_lambda >> Edge(label="Read images in buckets") << aws_image_bucket
