...
requests_per_second = [
   # Traffic jumps between 5 and 55 requests per second for an hour
    *[random.randint(5, 55) for i in range(0, 60)],
]
...
fig.write_image(f"{base_dir}/unstable_traffic_chart.png")