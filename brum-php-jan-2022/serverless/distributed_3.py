...
with Diagram("Distributed Example with AWS Services + Autoscaling", show=True):
    with Cluster("AWS Region"):
        ...
        with Cluster("Auto Scaling Group"):
            with Cluster("EC2 instance 1\n(t3.large, dual core, 4gb ram)"):
                nginx_1 = Custom("Nginx", f'{base_dir}/img/nginx.png')
                phpfpm_1 = Custom("PhpFpm", f'{base_dir}/img/phpfpm.png')
                nginx_1 >> Edge(style="dashed") << phpfpm_1
            
            with Cluster("EC2 instance 2\n(t3.large, dual core, 4gb ram)"):
                nginx_2 = Custom("Nginx", f'{base_dir}/img/nginx.png')
                phpfpm_2 = Custom("PhpFpm", f'{base_dir}/img/phpfpm.png')
